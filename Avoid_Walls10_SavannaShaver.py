...
while not done:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN and stage == PLAYING:
    ...
    if stage == PLAYING:
        ...
        for stuff in stuff_list:
            if intersects.rect_rect(player1, stuff):
        ...
        for things in things_list:
            ...
            if intersects.rect_rect(player1, things ):
                sec1 = ticks1//60 
                time_remaining = time_remaining - sec1
